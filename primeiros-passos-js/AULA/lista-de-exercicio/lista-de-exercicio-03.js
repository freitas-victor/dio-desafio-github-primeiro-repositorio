...
const formaPagamento = 4
    ...
    if (formaPagamento === 1){
        console.log(`O valor do produto é ${precoEtiqueta}, com o desconto fica ${precoEtiqueta - (precoEtiqueta * 10/100)}`);
    }else if (formaPagamento === 2){
        console.log(`O valor do produto é ${precoEtiqueta}, com o desconto fica ${precoEtiqueta - (precoEtiqueta * 15/100)}`);   
